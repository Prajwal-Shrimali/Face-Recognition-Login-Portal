...
import cv2
import numpy as np
from . import facenet  # Relative import
...
def run_face_recognition(list):
    ...
    recognized_names = []  # To store recognized names for 3 seconds
    ...
    with tf.Graph().as_default():
        ...
        with sess.as_default():
            ...
            while time.time() - start_time < 10:  # Run for 3 seconds
            ...
            # End of 3-second period
            video_capture.release()
            cv2.destroyAllWindows()

            # Find the most common name recognized
            if recognized_names:
                most_common_name = Counter(recognized_names).most_common(1)[0][0]
                print(f"Most common recognized name: {most_common_name}")
                list.append(most_common_name)
                return most_common_name
            else:
                print("No face detected")
                list.append("No face detected")
                return "No face detected"

# Assuming perform_recognition is the method in your code used to recognize the face
